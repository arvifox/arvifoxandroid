...
/**
 * Helper class to handle scroll behavior in case nested coordinatorlayouts
 * See issues https://stackoverflow.com/questions/34181372/coordinatorlayout-inside-another-coordinatorlayout
 */
class NestedScrollCoordinatorLayout
    @JvmOverloads
    constructor(
        context: Context,
...
//        defStyleAttr: Int = R.attr.coordinatorLayoutStyle
        ...
        override fun startNestedScroll(
            axes: Int,
            type: Int,
        ): Boolean = helper.startNestedScroll(axes, type)
        ...
        override fun canScrollVertically(direction: Int): Boolean {
            return scrollableView?.canScrollVertically(direction) ?: false || super.canScrollVertically(direction)
        }
    }
